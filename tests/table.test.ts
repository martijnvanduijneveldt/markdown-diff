...
describe('Table', () => {
  it('Should work for table', () => {
    ...
    expect(diff).equal('|<del>a</del><ins>1</ins>|b|\n|-|-|\n|c|d|');
  });
  ...
  it('Multi column add should work', () => {
    ...
    const diff = markdownDiff(oldStr, newStr);
    expect(diff).equal(`|<del>a</del><ins>1</ins>|<ins>2</ins>|<ins>a</ins>|<ins>b</ins>|
|-|-|-|-|
